...
//     testDisplay = [];
//     testDisplay.length = 2;

//     for (var i = 0; i < testDisplay.length; i++) {
//         testDisplay[i]= `<!-- Manager -->
//         <div class="role">
...
//                         <div class="id">
//                             <text>ID: <span class="input-num"></span></text></text>
//                         </div>
//                         <div class="email">
//                             <text>Email: <span class="inputs"><a href="mailto: "></a></span></text>
//                         </div>
//                         <div class="wild-card">
//                             <text>Office Number: <span class="input-num"></span></text>
//                         </div>
//                     </div>
//                 </div>
//             </div>
